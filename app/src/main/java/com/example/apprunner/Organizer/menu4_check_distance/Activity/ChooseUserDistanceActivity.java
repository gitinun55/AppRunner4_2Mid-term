...
public class ChooseUserDistanceActivity extends AppCompatActivity {
    ...
    private void Cal_distance(int id_user_run,int id_add){
        ...
        //Toast.makeText(requireContext(),Integer.toString(id_add),Toast.LENGTH_SHORT).show();
        call.enqueue(new Callback<List<UserListResponse>>() {
            ...
            public void onResponse(Call<List<UserListResponse>> call, Response<List<UserListResponse>> response) {
                ...
                for(int j=0;j<resultQuery_distance.size();j++){
                    ...
                    //Toast.makeText(requireContext(),Integer.toString(x),Toast.LENGTH_SHORT).show();
                    //Toast.makeText(requireContext(),Float.toString(history_distance),Toast.LENGTH_SHORT).show();
                ...
                //Toast.makeText(requireContext(),String.format("%.2f",result_distance),Toast.LENGTH_SHORT).show();
                //Toast.makeText(requireContext(),seriesOfNumbers.toString(),Toast.LENGTH_SHORT).show();
            }
