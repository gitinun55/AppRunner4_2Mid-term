...
public class UplodeStatistics extends AppCompatActivity {
    ...
    public void UploadStatic(){
        ...
        Call<ResultQuery> call = service.UploadStatic(new UplodeStatisticsDB(id_user,id_add,date,num,cal));
    ...
    private boolean validate(TextView result_date,TextView result_distance,EditText result_cal){
